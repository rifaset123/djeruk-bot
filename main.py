...
async def get_gemini_response(query: str) -> str:
    ...
    # jalankan yang blocking di thread, plus timeout
    def _call_gemini():
...
def main():
    if not TELEGRAM_TOKEN:
        print("TELEGRAM_TOKEN tidak ada di .env")
        return

    # Naikkan timeout Telegram supaya tidak gampang Timed out
    app = (
        Application.builder()
